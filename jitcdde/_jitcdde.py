...
def dde_from_module_file(location, n, max_delay, **kwargs):
	"""
	...
	max_delay : float
		same as for `jitcdde`
	kwargs : keyward arguments to be passed to `jitcdde`. This can be any argument of `jitcdde` except the above; it need not make sense though.
	
	Returns
	-------
	instance of `jitcdde`
		This is initiated with the functions found in the module file. Note that this may lack some functionalities, depending on the arguments you provide.
	"""
	...
	DDE = jitcdde(f, n=n, max_delay=max_delay, **kwargs)
	DDE.jitced = module
